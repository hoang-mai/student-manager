...
`,
    ...
    components: {
      ...
      schemas: {
        ...
        Semester: { type: 'object', properties: { id: { type: 'string' }, code: { type: 'string', example: '2024-2025-HK1' }, schoolYearId: { type: 'string', format: 'uuid' }, schoolYear: { type: 'string', example: '2024-2025' } } },
        TimeTable: { type: 'object', properties: { id: { type: 'string' }, userId: { type: 'string' }, semesterId: { type: 'string' }, schedules: { type: 'array', items: { type: 'object', properties: { day: { type: 'string' }, startTime: { type: 'string' }, endTime: { type: 'string' }, room: { type: 'string' }, subjectName: { type: 'string' }, week: { type: 'integer' } } } } } },
