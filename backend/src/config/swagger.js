...
`,
    ...
    components: {
      ...
      schemas: {
        ...
        Semester: { type: 'object', properties: { id: { type: 'string' }, code: { type: 'string', example: '1' }, schoolYearId: { type: 'string', format: 'uuid' }, schoolYear: { type: 'string', example: '2024-2025' } } },
